...
// Colors for chart - Custom SPOT Theme
const CHART_COLOR = '#1633F6';
const CHART_BG_START = 'rgba(22, 51, 246, 0.28)';
const CHART_BG_END = 'rgba(22, 51, 246, 0.0)';
...
function updateTable(data) {
    ...
    data.forEach((row, index) => {
        ...
        const fillColors = 'background:rgba(22,51,246,0.08);color:#122cd4;border-color:rgba(22,51,246,0.25)';
        ...
        tr.innerHTML = `
            ...
            <td class="td-evento"><span class="evento-badge" style="${fillColors}">${unitStr}</span></td>
        `;
...
// Tooltip
// ─────────────────────────────────────────────
// Custom SPOT ph-value-danger handling is also done with css classes
...
function exportToCSV() {
    ...
    link.setAttribute('download', 'Reporte_Instrumentos_SPOT.csv');
